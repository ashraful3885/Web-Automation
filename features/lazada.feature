Feature: Lazada Website Navigation
  ...
  Scenario: Navigate and View About Options
    Given the Lazada website is open
  ...
  Scenario: View "Press & Media" Page
    Given the Lazada website is open
  ...
  Scenario: Navigate and View "Our Job" Categories From Careers Options
      Given the Lazada website is open
      ...
      And I click on the "Go Back from Job List" link
      When I click on the "Go Back" link
      And I click on the "Technology" category
      ...
      And I click on the "Go Back from Job List" link
      When I click on the "Go Back" link
      And I click on the "Security" category
      ...
      And I click on the "Go Back from Job List" link
      When I click on the "Go Back" link
      And I click on the "Supply" category
      ...
      And I click on the "Go Back from Job List" link
      When I click on the "Go Back" link
      And I click on the "Corporate" category
      ...
      And I click on the "Go Back from Job List" link
      When I click on the "Go Back" link
      And I click on the "Customer" category
      ...
      And I click on the "Go Back from Job List" link
      When I click on the "Go Back" link
      And I click on the "Strategy" category
  ...
  Scenario: Navigate and View "Graduates & Interns" Categories From Careers Options
      Given the Lazada website is open
      When I click on the "Careers" dropdown
